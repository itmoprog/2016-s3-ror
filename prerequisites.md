...
2. Создадим новое Ruby on Rails приложение:
  ...
  > PS. Вы можете обратить внимание, что директория `/vagrant` на виртуальной машине синхронизируется с директорией на вашей основной машине, откуда вы запускаете Vagrant. Как я уже говорил, сам код вы будете редактировать локально, чтобы всё было быстро; запускаться же всё будет с виртуальной машины, чтобы не сталкиваться с проблемами на Windows и просто не засорять свою основную систему.
...
5. На вашей основной машине откройте браузер и введите туда полученный с виртуальной машины IP и порт `3000` (в моём случае это так):
  ...
  Поздравляю вас с первым Ruby on Rails-приложением! :smile:
